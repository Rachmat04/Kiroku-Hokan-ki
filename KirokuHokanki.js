...
(function() {
	...
	const TIMESTAMP_CONFIG = {
		monthMaps: {
			EN: { january: 1, february: 2, march: 3, april: 4, may: 5, june: 6, july: 7, august: 8, september: 9, october: 10, november: 11, december: 12, jan: 1, feb: 2, mar: 3, apr: 4, jun: 6, jul: 7, aug: 8, sep: 9, sept: 9, oct: 10, nov: 11, dec: 12 },
			ID: { januari: 1, februari: 2, maret: 3, april: 4, mei: 5, juni: 6, juli: 7, agustus: 8, september: 9, oktober: 10, november: 11, desember: 12 },
			AR: { 'يناير': 1, 'فبراير': 2, 'مارس': 3, 'أبريل': 4, 'مايو': 5, 'يونيو': 6, 'يوليو': 7, 'أغسطس': 8, 'سبتمبر': 9, 'أكتوبر': 10, 'نوفمبر': 11, 'ديسمبر': 12 },
			HE: { 'ינואר': 1, 'בינואר': 1, 'פברואר': 2, 'בפברואר': 2, 'מרץ': 3, 'במרץ': 3, 'אפריל': 4, 'באפריל': 4, 'מאי': 5, 'במאי': 5, 'יוני': 6, 'ביוני': 6, 'יולי': 7, 'ביולי': 7, 'אוגוסט': 8, 'באוגוסט': 8, 'ספטמבר': 9, 'בספטמבר': 9, 'אוקטובר': 10, 'באוקטובר': 10, 'נובמבר': 11, 'בנובמבר': 11, 'דצמבר': 12, 'בדצמבר': 12 },
			HI: { 'जनवरी': 1, 'फ़रवरी': 2, 'फरवरी': 2, 'मार्च': 3, 'अप्रैल': 4, 'मई': 5, 'जून': 6, 'जुलाई': 7, 'अगस्त': 8, 'सितंबर': 9, 'सितम्बर': 9, 'अक्टूबर': 10, 'नवंबर': 11, 'नवम्बर': 11, 'दिसंबर': 12, 'दिसम्बर': 12 },
			PNB: { 'جنوری': 1, 'فروری': 2, 'مارچ': 3, 'اپریل': 4, 'مئی': 5, 'جون': 6, 'جولائی': 7, 'اگست': 8, 'ستمبر': 9, 'اکتوبر': 10, 'نومبر': 11, 'دسمبر': 12 },
			BN: { 'জানুয়ারি': 1, 'ফেব্রুয়ারি': 2, 'মার্চ': 3, 'এপ্রিল': 4, 'মে': 5, 'জুন': 6, 'জুলাই': 7, 'আগস্ট': 8, 'সেপ্টেম্বর': 9, 'অক্টোবর': 10, 'নভেম্বর': 11, 'ডিসেম্বর': 12 },
			GOR_MIN: { 'pebruari': 2, 'mai': 5, 'nopember': 11 },
			ACE: { 'buleuen sa': 1, 'buleuen duwa': 2, 'buleuen lhèe': 3, 'buleuen peuet': 4, 'buleuen limöng': 5, 'buleuen nam': 6, 'buleuen tujôh': 7, 'buleuen lapan': 8, 'buleuen sikureueng': 9, 'buleuen siplôh': 10, 'buleuen siblaih': 11, 'buleuen duwa blah': 12 },
			ARZ: { 'يناير': 1, 'فبراير': 2, 'مارس': 3, 'أبريل': 4, 'مايو': 5, 'يونيو': 6, 'يوليو': 7, 'أغسطس': 8, 'سبتمبر': 9, 'أكتوبر': 10, 'نوفمبر': 11, 'ديسمبر': 12 },
			UR: { 'جنوری': 1, 'فروری': 2, 'مارچ': 3, 'اپریل': 4, 'مئی': 5, 'جون': 6, 'جولائی': 7, 'اگست': 8, 'ستمبر': 9, 'اکتوبر': 10, 'نومبر': 11, 'دسمبر': 12 },
			BAN: { 'januari': 1, 'pébruari': 2, 'maret': 3, 'april': 4, 'méi': 5, 'juni': 6, 'juli': 7, 'agustus': 8, 'séptémber': 9, 'oktober': 10, 'nopémber': 11, 'désémber': 12 },
			AF: { 'januarie': 1, 'februarie': 2, 'maart': 3, 'april': 4, 'mei': 5, 'junie': 6, 'julie': 7, 'augustus': 8, 'september': 9, 'oktober': 10, 'november': 11, 'desember': 12 },
			BR: { 'genver': 1, 'c\'hwevrer': 2, 'meurzh': 3, 'ebrel': 4, 'mae': 5, 'mezheven': 6, 'gouere': 7, 'eost': 8, 'gwengolo': 9, 'here': 10, 'du': 11, 'kerzu': 12 },
			CZ: { 'ledna': 1, 'února': 2, 'března': 3, 'dubna': 4, 'května': 5, 'června': 6, 'července': 7, 'srpna': 8, 'září': 9, 'října': 10, 'listopadu': 11, 'prosince': 12 },
			...
			EO: { 'januaro': 1, 'februaro': 2, 'marto': 3, 'aprilo': 4, 'majo': 5, 'junio': 6, 'julio': 7, 'aŭgusto': 8, 'septembro': 9, 'oktobro': 10, 'novembro': 11, 'decembro': 12 },
			FI: { 'tammikuuta': 1, 'helmikuuta': 2, 'maaliskuuta': 3, 'huhtikuuta': 4, 'toukokuuta': 5, 'kesäkuuta': 6, 'heinäkuuta': 7, 'elokuuta': 8, 'syyskuuta': 9, 'lokakuuta': 10, 'marraskuuta': 11, 'joulukuuta': 12 },
			FR: { 'janvier': 1, 'février': 2, 'mars': 3, 'avril': 4, 'mai': 5, 'juin': 6, 'juillet': 7, 'août': 8, 'septembre': 9, 'octobre': 10, 'novembre': 11, 'décembre': 12 },
			DE: { 'januar': 1, 'februar': 2, 'märz': 3, 'april': 4, 'mai': 5, 'juni': 6, 'juli': 7, 'august': 8, 'september': 9, 'oktober': 10, 'november': 11, 'dezember': 12 },
			EL: { 'ιανουαρίου': 1, 'φεβρουαρίου': 2, 'μαρτίου': 3, 'απριλίου': 4, 'μαΐου': 5, 'ιουνίου': 6, 'ιουλίου': 7, 'αυγούστου': 8, 'σεπτεμβρίου': 9, 'οκτωβρίου': 10, 'νοεμβρίου': 11, 'δεκεμβρίου': 12 },
			...
			AVK: { 'taneaksat': 1, 'toleaksat': 2, 'bareaksat': 3, 'balemeaksat': 4, 'alubeaksat': 5, 'teveaksat': 6, 'pereaksat': 7, 'anyusteaksat': 8, 'lerdeaksat': 9, 'saneaksat': 10, 'santaneaksat': 11, 'santoleaksat': 12 },
			PL: { 'stycznia': 1, 'lutego': 2, 'marca': 3, 'kwietnia': 4, 'maja': 5, 'czerwca': 6, 'lipca': 7, 'sierpnia': 8, 'września': 9, 'października': 10, 'listopada': 11, 'grudnia': 12 },
			NO: { 'januar': 1, 'februar': 2, 'mars': 3, 'april': 4, 'mai': 5, 'juni': 6, 'juli': 7, 'august': 8, 'september': 9, 'oktober': 10, 'november': 11, 'desember': 12 },
			NDS: { 'januar': 1, 'februar': 2, 'marz': 3, 'mär': 3, 'april': 4, 'mai': 5, 'juni': 6, 'juli': 7, 'august': 8, 'aug': 8, 'september': 9, 'septemmer': 9, 'oktober': 10, 'november': 11, 'novemmer': 11, 'dezember': 12, 'dezemmer': 12 },
			CY: { 'ionawr': 1, 'chwefror': 2, 'mawrth': 3, 'ebrill': 4, 'mai': 5, 'mehefin': 6, 'gorffennaf': 7, 'awst': 8, 'medi': 9, 'hydref': 10, 'tachwedd': 11, 'rhagfyr': 12 },
			SV: { 'januari': 1, 'februari': 2, 'mars': 3, 'april': 4, 'maj': 5, 'juni': 6, 'juli': 7, 'augusti': 8, 'september': 9, 'oktober': 10, 'november': 11, 'december': 12 },
			ES: { 'enero': 1, 'febrero': 2, 'marzo': 3, 'abril': 4, 'mayo': 5, 'junio': 6, 'julio': 7, 'agosto': 8, 'septiembre': 9, 'octubre': 10, 'noviembre': 11, 'diciembre': 12, 'ene': 1, 'feb': 2, 'mar': 3, 'abr': 4, 'may': 5, 'jun': 6, 'jul': 7, 'ago': 8, 'sep': 9, 'oct': 10, 'nov': 11, 'dic': 12 },
			SI: { 'ජනවාරි': 1, 'පෙබරවාරි': 2, 'මාර්තු': 3, 'අප්‍රේල්': 4, 'මැයි': 5, 'ජූනි': 6, 'ජූලි': 7, 'අගෝස්තු': 8, 'සැප්තැම්බර': 9, 'ඔක්තෝබර': 10, 'නොවැම්බර': 11, 'දෙසැම්බර්': 12 },
		...
		patterns: [
			{
				...
				extract(m) { return [+m[1], +m[2], +m[3], +m[4], +m[5]]; }
			},
			{
				id: 'iso-space',
			...
			},
			{
				...
				extract(m) { return [+m[3], +m[4], +m[5], +(m[6] || m[1] || 0), +(m[7] || m[2] || 0)]; }
			},
			{
				id: 'zh-min-nan',
			...
			},
			{
				...
				extract(m, { CZ }) { return [+m[3], +m[2], +m[1], +m[4], +m[5]]; }
			},
			{
				id: 'da',
	...
	async function getThreadLastTimestamp(threadContent) {
		...
		const MONTHS_LATIN = Object.assign({}, mm.EN, mm.ID, mm.AR, mm.HE, mm.HI, mm.PNB, mm.BN, mm.GOR_MIN);
		...
		const ctx = { MONTHS_LATIN, ...mm, pnbToNum, bnToNum };
	...
	async function archiveBatch(items, onProgress) {
		...
		for (const [archiveTitle, arcItems] of byArchive) {
			...
			try {
				...
				await api.postWithToken('csrf', {
					action: 'edit', title: archiveTitle, text: arcText.trim(),
		...
		if (ok.length > 0) {
			...
			await api.postWithToken('csrf', {
				action: 'edit', title: PAGE_NAME, text: srcText,
	...
	async function archiveThread(thread, archiveTitle) {
		const result = await archiveBatch([{ thread, archiveTitle }], () => {});
	...
	function openEmptyNotice() {
		const { overlay, body, footer } = createDialog({ title: 'Archive Manager', icon: '📦', small: true });
	...
	async function openArchiveManager(allThreads) {
		const items = allThreads.map(t => ({
			thread: t, ts: null, tsLoaded: false,
			year: new Date().getUTCFullYear(), archiveTitle: getArchiveTitle(new Date().getUTCFullYear()),
			status: 'pending', selected: false
		}));

		let filterDays = 0;

		const { overlay, body, footer } = createDialog({ title: 'Archive Manager', icon: '📦', onClose: () => {} });

		const toolbar = document.createElement('div');
		toolbar.className = 'ta-toolbar';

		const chkAll = document.createElement('input');
		chkAll.type = 'checkbox'; chkAll.id = 'ta-chk-all';
		const lblAll = document.createElement('label');
		lblAll.htmlFor = 'ta-chk-all'; lblAll.appendChild(chkAll);
		...
		loadTsBtn.style.fontSize = '0.85em'; loadTsBtn.textContent = '🕐 Load timestamps';
		...
		toolbar.appendChild(lblAll); toolbar.appendChild(loadTsBtn); toolbar.appendChild(filterWrap);
		...
		footerInfo.className = 'ta-footer-info'; footerInfo.id = 'ta-footer-info';
		footerInfo.textContent = '0 threads selected';

		const footerRight = document.createElement('div');
		footerRight.className = 'ta-dialog-footer-right';
		const cancelBtn = document.createElement('button');
		cancelBtn.className = 'mw-ui-button mw-ui-quiet'; cancelBtn.textContent = 'Close';
		cancelBtn.addEventListener('click', () => overlay.closeHandler());
		const archiveBtn = document.createElement('button');
		archiveBtn.className = 'mw-ui-button mw-ui-progressive'; archiveBtn.textContent = 'Archive selected';
		archiveBtn.disabled = true;

		footerRight.appendChild(cancelBtn); footerRight.appendChild(archiveBtn);
		footer.appendChild(footerInfo); footer.appendChild(footerRight);
		...
		function renderBadge(status) {
			const map = {
				pending: ['ta-badge-pending', '—'], loading: ['ta-badge-loading', '⏳'],
				ok: ['ta-badge-ok', '✅ Done'], error: ['ta-badge-error', '❌ Failed'],
		...
		function renderTable() {
			...
			if (!visible.length) {
				...
				tr.innerHTML = `<td colspan="6" style="text-align:center;padding:18px;color:#72777d">No threads match the current filter.</td>`;
			...
			visible.forEach((item, vi) => {
				...
				tr.querySelector('.ta-row-year').addEventListener('change', e => {
					...
					item.year = newYear; item.archiveTitle = getArchiveTitle(newYear); item.yearOverride = newYear;
					...
					sel.className = (newYear !== det) ? 'ta-year-sel ta-year-override ta-row-year' : 'ta-year-sel ta-row-year';
				});
		...
		loadTsBtn.addEventListener('click', async () => {
			loadTsBtn.disabled = true; loadTsBtn.textContent = '⏳ Loading…';
			for (let i = 0; i < items.length; i++) {
				items[i].status = 'loading'; renderTable();
				const ts = await getThreadLastTimestamp(items[i].thread.content);
				items[i].ts = ts; items[i].tsLoaded = true;
				...
				items[i].status = 'pending'; renderTable();
			}
			loadTsBtn.disabled = false; loadTsBtn.textContent = '🔄 Refresh timestamps';
		});
	...
	function openBulkConfirm(selected, allItems, managerOverlay, renderTable, updateFooterCount, archiveBtn, cancelBtnOuter) {
		...
		progressLog.className = 'ta-progress-log'; progressLog.id = 'ta-bulk-progress';
		bodyPad.appendChild(progressLog); body.appendChild(bodyPad);
		...
		const confirmBtn = addFooterBtn(footerRight2, 'Archive now', 'mw-ui-progressive', async () => {
			confirmBtn.disabled = true; c2.disabled = true; archiveBtn.disabled = true; cancelBtnOuter.disabled = true;
			...
			try {
				...
				batchResult = { ok: [], errors: selected.map(it => ({ title: it.thread.title, err: fatalErr })) };
			}
			...
			renderTable(); updateFooterCount();

			const doneCount = batchResult.ok.length;
			const errorCount = batchResult.errors.length;
			if (progEl) progEl.innerHTML = `<b>Done.</b> ${doneCount} succeeded, ${errorCount} failed.` + (errorCount ? ' Check the browser console for details.' : '');

			footerRight2.innerHTML = '';
			addFooterBtn(footerRight2, 'Close & reload', 'mw-ui-progressive', () => {
				overlay.closeHandler(); managerOverlay.closeHandler(); location.reload();
			});
			if (errorCount > 0) {
				addFooterBtn(footerRight2, 'Close without reload', 'mw-ui-quiet', () => {
					overlay.closeHandler(); cancelBtnOuter.disabled = false;
	...
	async function onArchiveBtnClick(thread, btn) {
		...
		const { overlay, body, footer } = createDialog({
			title: 'Archive section', icon: '🗃️', small: true,
		...
		let timestamp = null;
		try { timestamp = await getThreadLastTimestamp(thread.content); } catch (e) {}
		...
		function renderSingleBody() {
			...
			bodyPad.querySelector('#ta-single-year').addEventListener('change', e => {
				...
				renderSingleBody(); attachConfirm();
			});
		}
		renderSingleBody();

		const footerRight = document.createElement('div');
		footerRight.className = 'ta-dialog-footer-right'; footer.appendChild(footerRight);
		...
		function attachConfirm() {
			...
			confirmBtn = addFooterBtn(footerRight, 'Archive', 'mw-ui-progressive', async () => {
				...
				try {
					...
					addFooterBtn(footerRight, 'Close & reload', 'mw-ui-progressive', () => { overlay.closeHandler(); location.reload(); });
				} catch (e) {
	...
	async function injectButtons() {
		...
		if (!document.getElementById('ta-fab')) {
			...
			fab.id = 'ta-fab';
			fab.title = threads.length ? `Archive Manager (${threads.length} thread${threads.length !== 1 ? 's' : ''})` : 'Archive Manager — no threads found';
		...
		headings.forEach((heading, i) => {
			...
			btn.className = 'ta-btn'; btn.textContent = '🗃️'; btn.title = 'Archive this section';
			btn.addEventListener('click', e => { e.preventDefault(); onArchiveBtnClick(thread, btn); });
